###########################################################################
## Makefile generated for component 'run_q2_test'. 
## 
## Makefile     : run_q2_test.mk
## Generated on : Sun Dec 10 17:47:58 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\run_q2_test.rt-win64
...
COMPILER_COMMAND_FILE     = run_q2_test_comp.rsp
CMD_FILE                  = run_q2_test.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\run_q2_test.rt-win64
...
DEFINES_STANDARD = -DMODEL=run_q2_test -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\run_q2_test_quarc_win64\rtGetInf.c $(START_DIR)\run_q2_test_quarc_win64\rtGetNaN.c $(START_DIR)\run_q2_test_quarc_win64\rt_nonfinite.c $(START_DIR)\run_q2_test_quarc_win64\run_q2_test.c $(START_DIR)\run_q2_test_quarc_win64\run_q2_test_data.c $(START_DIR)\run_q2_test_quarc_win64\run_q2_test_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj run_q2_test.obj run_q2_test_data.obj run_q2_test_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\run_q2_test_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\run_q2_test_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : $(START_DIR)\run_q2_test_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q2_test_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\run_q2_test_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q2_test_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\run_q2_test_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q2_test_quarc_win64\rt_nonfinite.c


run_q2_test.obj : $(START_DIR)\run_q2_test_quarc_win64\run_q2_test.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q2_test_quarc_win64\run_q2_test.c


run_q2_test_data.obj : $(START_DIR)\run_q2_test_quarc_win64\run_q2_test_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q2_test_quarc_win64\run_q2_test_data.c


run_q2_test_main.obj : $(START_DIR)\run_q2_test_quarc_win64\run_q2_test_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q2_test_quarc_win64\run_q2_test_main.c
