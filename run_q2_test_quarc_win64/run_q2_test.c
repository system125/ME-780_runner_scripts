...
#include "run_q2_test_dt.h"

/* Block signals (default storage) */
B_run_q2_test_T run_q2_test_B;

/* Block states (default storage) */
DW_run_q2_test_T run_q2_test_DW;

/* Real-time model */
static RT_MODEL_run_q2_test_T run_q2_test_M_;
RT_MODEL_run_q2_test_T *const run_q2_test_M = &run_q2_test_M_;

/* Model output function */
void run_q2_test_output(void)
{
  ...
  /* S-Function Block: run_q2_test/Plant/HIL Read Encoder1 (hil_read_encoder_block) */
  {
    t_error result = hil_read_encoder(run_q2_test_DW.HILInitialize_Card,
      &run_q2_test_P.HILReadEncoder1_channels, 1,
      &run_q2_test_DW.HILReadEncoder1_Buffer);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(run_q2_test_M, _rt_error_message);
    } else {
      rtb_CableGain = run_q2_test_DW.HILReadEncoder1_Buffer;
    }
  }

  /* Gain: '<S2>/mm//cn' */
  run_q2_test_B.mmcn = run_q2_test_P.mmcn_Gain * rtb_CableGain;

  /* S-Function (inverse_modulus_block): '<S2>/Inverse Modulus' */
  /* S-Function Block: run_q2_test/Plant/Inverse Modulus (inverse_modulus_block) */
  {
    static const real_T sampling_period = 0.001;
    real_T half_range = run_q2_test_P.InverseModulus_Modulus / 2.0;
    real_T du, dy;
    if (run_q2_test_DW.InverseModulus_FirstSample) {
      run_q2_test_DW.InverseModulus_FirstSample = false;
      run_q2_test_DW.InverseModulus_PreviousInput = run_q2_test_B.mmcn;
    }

    du = (real_T) run_q2_test_B.mmcn -
      run_q2_test_DW.InverseModulus_PreviousInput;
    if (du > half_range) {
      run_q2_test_DW.InverseModulus_Revolutions =
        run_q2_test_DW.InverseModulus_Revolutions - 1;
      dy = du - run_q2_test_P.InverseModulus_Modulus;
    ...
    run_q2_test_B.InverseModulus = run_q2_test_B.mmcn +
      run_q2_test_DW.InverseModulus_Revolutions *
  ...
  /* S-Function Block: run_q2_test/Plant/HIL Read Encoder 2 (hil_read_encoder_block) */
  {
    t_error result = hil_read_encoder(run_q2_test_DW.HILInitialize_Card,
      &run_q2_test_P.HILReadEncoder2_channels, 1,
    ...
    if (result < 0) {
      ...
      rtb_CableGain = run_q2_test_DW.HILReadEncoder2_Buffer;
    }
  }

  /* Gain: '<S2>/mm//cn - 2' */
  run_q2_test_B.mmcn2 = run_q2_test_P.mmcn2_Gain * rtb_CableGain;

  /* S-Function (inverse_modulus_block): '<S2>/Inverse Modulus1' */
  /* S-Function Block: run_q2_test/Plant/Inverse Modulus1 (inverse_modulus_block) */
  {
    static const real_T sampling_period = 0.001;
    real_T half_range = run_q2_test_P.InverseModulus1_Modulus / 2.0;
    real_T du, dy;
    if (run_q2_test_DW.InverseModulus1_FirstSample) {
      run_q2_test_DW.InverseModulus1_FirstSample = false;
      run_q2_test_DW.InverseModulus1_PreviousInput = run_q2_test_B.mmcn2;
    }

    du = (real_T) run_q2_test_B.mmcn2 -
      run_q2_test_DW.InverseModulus1_PreviousInput;
    if (du > half_range) {
      run_q2_test_DW.InverseModulus1_Revolutions =
        run_q2_test_DW.InverseModulus1_Revolutions - 1;
      dy = du - run_q2_test_P.InverseModulus1_Modulus;
    } else if (du < -half_range) {
      run_q2_test_DW.InverseModulus1_Revolutions =
        run_q2_test_DW.InverseModulus1_Revolutions + 1;
      dy = du + run_q2_test_P.InverseModulus1_Modulus;
    ...
    rtb_InverseModulus1 = run_q2_test_B.mmcn2 +
      run_q2_test_DW.InverseModulus1_Revolutions *
  ...
  {
    real_T *pDataValues = (real_T *) run_q2_test_DW.FromWorkspace2_PWORK.DataPtr;
    real_T *pTimeValues = (real_T *) run_q2_test_DW.FromWorkspace2_PWORK.TimePtr;
    int_T currTimeIndex = run_q2_test_DW.FromWorkspace2_IWORK.PrevIndex;
    real_T t = run_q2_test_M->Timing.t[0];
    ...
    run_q2_test_DW.FromWorkspace2_IWORK.PrevIndex = currTimeIndex;
    ...
    /* Post output */
    {
      ...
      if (t1 == t2) {
        if (t < t1) {
          run_q2_test_B.FromWorkspace2 = pDataValues[currTimeIndex];
        } else {
          run_q2_test_B.FromWorkspace2 = pDataValues[currTimeIndex + 1];
        }
      } else {
        ...
        run_q2_test_B.FromWorkspace2 = (real_T) rtInterpolate(d1, d2, f1, f2);
        pDataValues += 1701;
      }
    }
  }
  ...
  /* Sum: '<Root>/Sum' */
  rtb_Sum = run_q2_test_B.FromWorkspace2 - run_q2_test_B.InverseModulus;
   ...
   *  UnitDelay: '<S1>/UD'
   */
  run_q2_test_DW.DiscreteTransferFcn_tmp = ((run_q2_test_B.TSamp -
    run_q2_test_DW.UD_DSTATE) - run_q2_test_P.DiscreteTransferFcn_DenCoef[1] *
    run_q2_test_DW.DiscreteTransferFcn_states) /
    run_q2_test_P.DiscreteTransferFcn_DenCoef[0];

  /* DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn' */
  run_q2_test_B.DiscreteTransferFcn = run_q2_test_P.DiscreteTransferFcn_NumCoef
    [0] * run_q2_test_DW.DiscreteTransferFcn_tmp +
    run_q2_test_P.DiscreteTransferFcn_NumCoef[1] *
    run_q2_test_DW.DiscreteTransferFcn_states;
   ...
   */
  rtb_CableGain = run_q2_test_B.Sum1;

  /* Saturate: '<Root>/Saturation' */
  if (rtb_CableGain > run_q2_test_P.Saturation_UpperSat) {
    /* Saturate: '<Root>/Saturation' */
    run_q2_test_B.Saturation = run_q2_test_P.Saturation_UpperSat;
  } else if (rtb_CableGain < run_q2_test_P.Saturation_LowerSat) {
    /* Saturate: '<Root>/Saturation' */
    run_q2_test_B.Saturation = run_q2_test_P.Saturation_LowerSat;
  } else {
    /* Saturate: '<Root>/Saturation' */
    run_q2_test_B.Saturation = rtb_CableGain;
  }

  /* End of Saturate: '<Root>/Saturation' */

  /* Gain: '<S2>/Cable Gain' */
  rtb_CableGain = run_q2_test_P.CableGain_Gain * run_q2_test_B.Saturation;

  /* S-Function (hil_write_analog_block): '<S2>/HIL Write Analog' */

  /* S-Function Block: run_q2_test/Plant/HIL Write Analog (hil_write_analog_block) */
  {
    t_error result;
    result = hil_write_analog(run_q2_test_DW.HILInitialize_Card,
      &run_q2_test_P.HILWriteAnalog_channels, 1, &rtb_CableGain);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(run_q2_test_M, _rt_error_message);
...
void run_q2_test_update(void)
{
   ...
   */
  if (!(++run_q2_test_M->Timing.clockTick0)) {
    ++run_q2_test_M->Timing.clockTickH0;
  }

  run_q2_test_M->Timing.t[0] = run_q2_test_M->Timing.clockTick0 *
    run_q2_test_M->Timing.stepSize0 + run_q2_test_M->Timing.clockTickH0 *
    run_q2_test_M->Timing.stepSize0 * 4294967296.0;

  {
     ...
     */
    if (!(++run_q2_test_M->Timing.clockTick1)) {
      ++run_q2_test_M->Timing.clockTickH1;
    }

    run_q2_test_M->Timing.t[1] = run_q2_test_M->Timing.clockTick1 *
      run_q2_test_M->Timing.stepSize1 + run_q2_test_M->Timing.clockTickH1 *
      run_q2_test_M->Timing.stepSize1 * 4294967296.0;
  }
}

/* Model initialize function */
void run_q2_test_initialize(void)
{
  /* Start for S-Function (hil_initialize_block): '<S2>/HIL Initialize' */

  /* S-Function Block: run_q2_test/Plant/HIL Initialize (hil_initialize_block) */
  {
    t_int result;
    t_boolean is_switching;
    result = hil_open("q2_usb", "0", &run_q2_test_DW.HILInitialize_Card);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(run_q2_test_M, _rt_error_message);
    ...
    is_switching = false;
    result = hil_set_card_specific_options(run_q2_test_DW.HILInitialize_Card,
    ...
    result = hil_watchdog_clear(run_q2_test_DW.HILInitialize_Card);
    ...
    if ((run_q2_test_P.HILInitialize_AIPStart && !is_switching) ||
        (run_q2_test_P.HILInitialize_AIPEnter && is_switching)) {
      run_q2_test_DW.HILInitialize_AIMinimums[0] =
        (run_q2_test_P.HILInitialize_AILow);
      run_q2_test_DW.HILInitialize_AIMinimums[1] =
        (run_q2_test_P.HILInitialize_AILow);
      run_q2_test_DW.HILInitialize_AIMaximums[0] =
        run_q2_test_P.HILInitialize_AIHigh;
      run_q2_test_DW.HILInitialize_AIMaximums[1] =
        run_q2_test_P.HILInitialize_AIHigh;
      result = hil_set_analog_input_ranges(run_q2_test_DW.HILInitialize_Card,
        run_q2_test_P.HILInitialize_AIChannels, 2U,
        &run_q2_test_DW.HILInitialize_AIMinimums[0],
        &run_q2_test_DW.HILInitialize_AIMaximums[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
    ...
    if ((run_q2_test_P.HILInitialize_AOPStart && !is_switching) ||
        (run_q2_test_P.HILInitialize_AOPEnter && is_switching)) {
      run_q2_test_DW.HILInitialize_AOMinimums[0] =
        (run_q2_test_P.HILInitialize_AOLow);
      run_q2_test_DW.HILInitialize_AOMinimums[1] =
        (run_q2_test_P.HILInitialize_AOLow);
      run_q2_test_DW.HILInitialize_AOMaximums[0] =
        run_q2_test_P.HILInitialize_AOHigh;
      run_q2_test_DW.HILInitialize_AOMaximums[1] =
        run_q2_test_P.HILInitialize_AOHigh;
      result = hil_set_analog_output_ranges(run_q2_test_DW.HILInitialize_Card,
        run_q2_test_P.HILInitialize_AOChannels, 2U,
        &run_q2_test_DW.HILInitialize_AOMinimums[0],
        &run_q2_test_DW.HILInitialize_AOMaximums[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
    ...
    if ((run_q2_test_P.HILInitialize_AOStart && !is_switching) ||
        (run_q2_test_P.HILInitialize_AOEnter && is_switching)) {
      run_q2_test_DW.HILInitialize_AOVoltages[0] =
        run_q2_test_P.HILInitialize_AOInitial;
      run_q2_test_DW.HILInitialize_AOVoltages[1] =
        run_q2_test_P.HILInitialize_AOInitial;
      result = hil_write_analog(run_q2_test_DW.HILInitialize_Card,
        run_q2_test_P.HILInitialize_AOChannels, 2U,
        &run_q2_test_DW.HILInitialize_AOVoltages[0]);
    ...
    if (run_q2_test_P.HILInitialize_AOReset) {
      run_q2_test_DW.HILInitialize_AOVoltages[0] =
    ...
    if ((run_q2_test_P.HILInitialize_EIPStart && !is_switching) ||
        (run_q2_test_P.HILInitialize_EIPEnter && is_switching)) {
      run_q2_test_DW.HILInitialize_QuadratureModes[0] =
        run_q2_test_P.HILInitialize_EIQuadrature;
      run_q2_test_DW.HILInitialize_QuadratureModes[1] =
        run_q2_test_P.HILInitialize_EIQuadrature;
      result = hil_set_encoder_quadrature_mode(run_q2_test_DW.HILInitialize_Card,
        run_q2_test_P.HILInitialize_EIChannels, 2U, (t_encoder_quadrature_mode *)
        &run_q2_test_DW.HILInitialize_QuadratureModes[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
    ...
    if ((run_q2_test_P.HILInitialize_EIStart && !is_switching) ||
        (run_q2_test_P.HILInitialize_EIEnter && is_switching)) {
      run_q2_test_DW.HILInitialize_InitialEICounts[0] =
        run_q2_test_P.HILInitialize_EIInitial;
      run_q2_test_DW.HILInitialize_InitialEICounts[1] =
        run_q2_test_P.HILInitialize_EIInitial;
      result = hil_set_encoder_counts(run_q2_test_DW.HILInitialize_Card,
        run_q2_test_P.HILInitialize_EIChannels, 2U,
        &run_q2_test_DW.HILInitialize_InitialEICounts[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
  ...
  /* S-Function Block: run_q2_test/Plant/Inverse Modulus (inverse_modulus_block) */
  {
    run_q2_test_DW.InverseModulus_FirstSample = true;
    run_q2_test_DW.InverseModulus_Revolutions = 0;
  }
  ...
  /* S-Function Block: run_q2_test/Plant/Inverse Modulus1 (inverse_modulus_block) */
  {
    run_q2_test_DW.InverseModulus1_FirstSample = true;
    run_q2_test_DW.InverseModulus1_Revolutions = 0;
  }
  ...
  /* Start for FromWorkspace: '<Root>/From Workspace2' */
  {
    ...
    run_q2_test_DW.FromWorkspace2_PWORK.TimePtr = (void *) pTimeValues0;
    run_q2_test_DW.FromWorkspace2_PWORK.DataPtr = (void *) pDataValues0;
    run_q2_test_DW.FromWorkspace2_IWORK.PrevIndex = 0;
  }
  ...
  run_q2_test_DW.UD_DSTATE = run_q2_test_P.DiscreteDerivative_ICPrevScaled;
...
void run_q2_test_terminate(void)
{
  ...
  /* S-Function Block: run_q2_test/Plant/HIL Initialize (hil_initialize_block) */
  {
    ...
    hil_task_stop_all(run_q2_test_DW.HILInitialize_Card);
    hil_monitor_stop_all(run_q2_test_DW.HILInitialize_Card);
    is_switching = false;
    if ((run_q2_test_P.HILInitialize_AOTerminate && !is_switching) ||
        (run_q2_test_P.HILInitialize_AOExit && is_switching)) {
      run_q2_test_DW.HILInitialize_AOVoltages[0] =
    ...
    if (num_final_analog_outputs > 0) {
      result = hil_write_analog(run_q2_test_DW.HILInitialize_Card,
        run_q2_test_P.HILInitialize_AOChannels, num_final_analog_outputs,
        &run_q2_test_DW.HILInitialize_AOVoltages[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
    ...
    hil_task_delete_all(run_q2_test_DW.HILInitialize_Card);
    hil_monitor_delete_all(run_q2_test_DW.HILInitialize_Card);
    hil_close(run_q2_test_DW.HILInitialize_Card);
    run_q2_test_DW.HILInitialize_Card = NULL;
  }
}
...
void MdlStart(void)
{
  run_q2_test_initialize();
}

void MdlTerminate(void)
{
  run_q2_test_terminate();
}

/* Registration function */
RT_MODEL_run_q2_test_T *run_q2_test(void)
{
  /* Registration code */
  ...
  (void) memset((void *)run_q2_test_M, 0,
                sizeof(RT_MODEL_run_q2_test_T));

  {
    /* Setup solver object */
    rtsiSetSimTimeStepPtr(&run_q2_test_M->solverInfo,
                          &run_q2_test_M->Timing.simTimeStep);
    rtsiSetTPtr(&run_q2_test_M->solverInfo, &rtmGetTPtr(run_q2_test_M));
    rtsiSetStepSizePtr(&run_q2_test_M->solverInfo,
                       &run_q2_test_M->Timing.stepSize0);
    rtsiSetErrorStatusPtr(&run_q2_test_M->solverInfo, (&rtmGetErrorStatus
      (run_q2_test_M)));
    rtsiSetRTModelPtr(&run_q2_test_M->solverInfo, run_q2_test_M);
  }

  rtsiSetSimTimeStep(&run_q2_test_M->solverInfo, MAJOR_TIME_STEP);
  rtsiSetSolverName(&run_q2_test_M->solverInfo,"FixedStepDiscrete");

  /* Initialize timing info */
  {
    int_T *mdlTsMap = run_q2_test_M->Timing.sampleTimeTaskIDArray;
    mdlTsMap[0] = 0;
    mdlTsMap[1] = 1;

    /* polyspace +2 MISRA2012:D4.1 [Justified:Low] "run_q2_test_M points to
       static memory which is guaranteed to be non-NULL" */
    run_q2_test_M->Timing.sampleTimeTaskIDPtr = (&mdlTsMap[0]);
    run_q2_test_M->Timing.sampleTimes = (&run_q2_test_M->
      Timing.sampleTimesArray[0]);
    run_q2_test_M->Timing.offsetTimes = (&run_q2_test_M->
      Timing.offsetTimesArray[0]);

    /* task periods */
    run_q2_test_M->Timing.sampleTimes[0] = (0.0);
    run_q2_test_M->Timing.sampleTimes[1] = (0.001);

    /* task offsets */
    run_q2_test_M->Timing.offsetTimes[0] = (0.0);
    run_q2_test_M->Timing.offsetTimes[1] = (0.0);
  }

  rtmSetTPtr(run_q2_test_M, &run_q2_test_M->Timing.tArray[0]);

  {
    int_T *mdlSampleHits = run_q2_test_M->Timing.sampleHitArray;
    mdlSampleHits[0] = 1;
    mdlSampleHits[1] = 1;
    run_q2_test_M->Timing.sampleHits = (&mdlSampleHits[0]);
  }

  rtmSetTFinal(run_q2_test_M, 1.712);
  run_q2_test_M->Timing.stepSize0 = 0.001;
...

  {
    ...
    run_q2_test_M->extModeInfo = (&rt_ExtModeInfo);
    rteiSetSubSystemActiveVectorAddresses(&rt_ExtModeInfo, systemRan);
    systemRan[0] = &rtAlwaysEnabled;
    rteiSetModelMappingInfoPtr(run_q2_test_M->extModeInfo,
      &run_q2_test_M->SpecialInfo.mappingInfo);
    rteiSetChecksumsPtr(run_q2_test_M->extModeInfo,
                        run_q2_test_M->Sizes.checksums);
    rteiSetTPtr(run_q2_test_M->extModeInfo, rtmGetTPtr(run_q2_test_M));
  }

  run_q2_test_M->solverInfoPtr = (&run_q2_test_M->solverInfo);
  run_q2_test_M->Timing.stepSize = (0.001);
  rtsiSetFixedStepSize(&run_q2_test_M->solverInfo, 0.001);
  rtsiSetSolverMode(&run_q2_test_M->solverInfo, SOLVER_MODE_SINGLETASKING);

  /* block I/O */
  run_q2_test_M->blockIO = ((void *) &run_q2_test_B);
  (void) memset(((void *) &run_q2_test_B), 0,
                sizeof(B_run_q2_test_T));

  /* parameters */
  run_q2_test_M->defaultParam = ((real_T *)&run_q2_test_P);

  /* states (dwork) */
  run_q2_test_M->dwork = ((void *) &run_q2_test_DW);
  (void) memset((void *)&run_q2_test_DW, 0,
                sizeof(DW_run_q2_test_T));
  ...
  /* data type transition information */
  {
    ...
    (void) memset((char_T *) &dtInfo, 0,
                  sizeof(dtInfo));
    run_q2_test_M->SpecialInfo.mappingInfo = (&dtInfo);
  ...
  /* Initialize Sizes */
  run_q2_test_M->Sizes.numContStates = (0);/* Number of continuous states */
  run_q2_test_M->Sizes.numY = (0);     /* Number of model outputs */
  run_q2_test_M->Sizes.numU = (0);     /* Number of model inputs */
  run_q2_test_M->Sizes.sysDirFeedThru = (0);/* The model is not direct feedthrough */
  run_q2_test_M->Sizes.numSampTimes = (2);/* Number of sample times */
  run_q2_test_M->Sizes.numBlocks = (26);/* Number of blocks */
  run_q2_test_M->Sizes.numBlockIO = (12);/* Number of block outputs */
  run_q2_test_M->Sizes.numBlockPrms = (84);/* Sum of parameter "widths" */
  return run_q2_test_M;
}
