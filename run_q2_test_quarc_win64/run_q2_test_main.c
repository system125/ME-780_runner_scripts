...
typedef RT_MODEL_run_q2_test_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * run_q2_test(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(run_q2_test_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://run_q2_test:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: run_q2_test -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
