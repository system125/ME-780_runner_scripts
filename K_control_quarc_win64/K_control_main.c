...
typedef RT_MODEL_K_control_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * K_control(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(K_control_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://K_control:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: K_control -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
