###########################################################################
## Makefile generated for component 'K_control'. 
## 
## Makefile     : K_control.mk
## Generated on : Sat Dec 09 23:53:03 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\K_control.rt-win64
...
COMPILER_COMMAND_FILE     = K_control_comp.rsp
CMD_FILE                  = K_control.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\K_control.rt-win64
...
DEFINES_STANDARD = -DMODEL=K_control -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\K_control_quarc_win64\K_control.c $(START_DIR)\K_control_quarc_win64\K_control_data.c $(START_DIR)\K_control_quarc_win64\K_control_main.c $(START_DIR)\K_control_quarc_win64\rtGetInf.c $(START_DIR)\K_control_quarc_win64\rtGetNaN.c $(START_DIR)\K_control_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = K_control.obj K_control_data.obj K_control_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\K_control_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\K_control_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
K_control.obj : $(START_DIR)\K_control_quarc_win64\K_control.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\K_control_quarc_win64\K_control.c


K_control_data.obj : $(START_DIR)\K_control_quarc_win64\K_control_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\K_control_quarc_win64\K_control_data.c


K_control_main.obj : $(START_DIR)\K_control_quarc_win64\K_control_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\K_control_quarc_win64\K_control_main.c


rtGetInf.obj : $(START_DIR)\K_control_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\K_control_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\K_control_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\K_control_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\K_control_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\K_control_quarc_win64\rt_nonfinite.c
