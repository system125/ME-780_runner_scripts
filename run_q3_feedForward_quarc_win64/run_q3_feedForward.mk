###########################################################################
## Makefile generated for component 'run_q3_feedForward'. 
## 
## Makefile     : run_q3_feedForward.mk
## Generated on : Sat Dec 09 05:59:19 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\run_q3_feedForward.rt-win64
...
PRODUCT_NAME              = run_q3_feedForward
MAKEFILE                  = run_q3_feedForward.mk
...
COMPILER_COMMAND_FILE     = run_q3_feedForward_comp.rsp
CMD_FILE                  = run_q3_feedForward.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\run_q3_feedForward.rt-win64
...
DEFINES_STANDARD = -DMODEL=run_q3_feedForward -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\run_q3_feedForward_quarc_win64\rtGetInf.c $(START_DIR)\run_q3_feedForward_quarc_win64\rtGetNaN.c $(START_DIR)\run_q3_feedForward_quarc_win64\rt_nonfinite.c $(START_DIR)\run_q3_feedForward_quarc_win64\run_q3_feedForward.c $(START_DIR)\run_q3_feedForward_quarc_win64\run_q3_feedForward_data.c $(START_DIR)\run_q3_feedForward_quarc_win64\run_q3_feedForward_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj run_q3_feedForward.obj run_q3_feedForward_data.obj run_q3_feedForward_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\run_q3_feedForward_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\run_q3_feedForward_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : $(START_DIR)\run_q3_feedForward_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q3_feedForward_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\run_q3_feedForward_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q3_feedForward_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\run_q3_feedForward_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q3_feedForward_quarc_win64\rt_nonfinite.c


run_q3_feedForward.obj : $(START_DIR)\run_q3_feedForward_quarc_win64\run_q3_feedForward.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q3_feedForward_quarc_win64\run_q3_feedForward.c


run_q3_feedForward_data.obj : $(START_DIR)\run_q3_feedForward_quarc_win64\run_q3_feedForward_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q3_feedForward_quarc_win64\run_q3_feedForward_data.c


run_q3_feedForward_main.obj : $(START_DIR)\run_q3_feedForward_quarc_win64\run_q3_feedForward_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q3_feedForward_quarc_win64\run_q3_feedForward_main.c
