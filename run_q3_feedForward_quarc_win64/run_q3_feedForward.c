...
#include "run_q3_feedForward.h"
#include "run_q3_feedForward_private.h"
#include "run_q3_feedForward_dt.h"

/* Block signals (default storage) */
B_run_q3_feedForward_T run_q3_feedForward_B;

/* Block states (default storage) */
DW_run_q3_feedForward_T run_q3_feedForward_DW;

/* Real-time model */
static RT_MODEL_run_q3_feedForward_T run_q3_feedForward_M_;
RT_MODEL_run_q3_feedForward_T *const run_q3_feedForward_M =
  &run_q3_feedForward_M_;

/* Model output function */
void run_q3_feedForward_output(void)
{
  ...
  /* S-Function Block: run_q3_feedForward/Plant/HIL Read Encoder1 (hil_read_encoder_block) */
  {
    t_error result = hil_read_encoder(run_q3_feedForward_DW.HILInitialize_Card,
      &run_q3_feedForward_P.HILReadEncoder1_channels, 1,
      &run_q3_feedForward_DW.HILReadEncoder1_Buffer);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(run_q3_feedForward_M, _rt_error_message);
    } else {
      rtb_CableGain = run_q3_feedForward_DW.HILReadEncoder1_Buffer;
    }
  }

  /* Gain: '<S3>/mm//cn' */
  run_q3_feedForward_B.mmcn = run_q3_feedForward_P.mmcn_Gain * rtb_CableGain;

  /* S-Function (inverse_modulus_block): '<S3>/Inverse Modulus' */
  /* S-Function Block: run_q3_feedForward/Plant/Inverse Modulus (inverse_modulus_block) */
  {
    static const real_T sampling_period = 0.001;
    real_T half_range = run_q3_feedForward_P.InverseModulus_Modulus / 2.0;
    real_T du, dy;
    if (run_q3_feedForward_DW.InverseModulus_FirstSample) {
      run_q3_feedForward_DW.InverseModulus_FirstSample = false;
      run_q3_feedForward_DW.InverseModulus_PreviousInput =
        run_q3_feedForward_B.mmcn;
    }

    du = (real_T) run_q3_feedForward_B.mmcn -
      run_q3_feedForward_DW.InverseModulus_PreviousInput;
    if (du > half_range) {
      run_q3_feedForward_DW.InverseModulus_Revolutions =
        run_q3_feedForward_DW.InverseModulus_Revolutions - 1;
      dy = du - run_q3_feedForward_P.InverseModulus_Modulus;
    ...
    run_q3_feedForward_B.InverseModulus = run_q3_feedForward_B.mmcn +
      run_q3_feedForward_DW.InverseModulus_Revolutions *
  ...
  /* S-Function Block: run_q3_feedForward/Plant/HIL Read Encoder 2 (hil_read_encoder_block) */
  {
    t_error result = hil_read_encoder(run_q3_feedForward_DW.HILInitialize_Card,
      &run_q3_feedForward_P.HILReadEncoder2_channels, 1,
    ...
    if (result < 0) {
      ...
      rtb_CableGain = run_q3_feedForward_DW.HILReadEncoder2_Buffer;
    }
  }

  /* Gain: '<S3>/mm//cn - 2' */
  run_q3_feedForward_B.mmcn2 = run_q3_feedForward_P.mmcn2_Gain * rtb_CableGain;

  /* S-Function (inverse_modulus_block): '<S3>/Inverse Modulus1' */
  /* S-Function Block: run_q3_feedForward/Plant/Inverse Modulus1 (inverse_modulus_block) */
  {
    static const real_T sampling_period = 0.001;
    real_T half_range = run_q3_feedForward_P.InverseModulus1_Modulus / 2.0;
    real_T du, dy;
    if (run_q3_feedForward_DW.InverseModulus1_FirstSample) {
      run_q3_feedForward_DW.InverseModulus1_FirstSample = false;
      run_q3_feedForward_DW.InverseModulus1_PreviousInput =
        run_q3_feedForward_B.mmcn2;
    }

    du = (real_T) run_q3_feedForward_B.mmcn2 -
      run_q3_feedForward_DW.InverseModulus1_PreviousInput;
    if (du > half_range) {
      run_q3_feedForward_DW.InverseModulus1_Revolutions =
        run_q3_feedForward_DW.InverseModulus1_Revolutions - 1;
      dy = du - run_q3_feedForward_P.InverseModulus1_Modulus;
    } else if (du < -half_range) {
      run_q3_feedForward_DW.InverseModulus1_Revolutions =
        run_q3_feedForward_DW.InverseModulus1_Revolutions + 1;
      dy = du + run_q3_feedForward_P.InverseModulus1_Modulus;
    ...
    rtb_InverseModulus1 = run_q3_feedForward_B.mmcn2 +
      run_q3_feedForward_DW.InverseModulus1_Revolutions *
  ...
  /* FromWorkspace: '<Root>/From Workspace1' */
  {
    real_T *pDataValues = (real_T *)
      run_q3_feedForward_DW.FromWorkspace1_PWORK.DataPtr;
    real_T *pTimeValues = (real_T *)
      run_q3_feedForward_DW.FromWorkspace1_PWORK.TimePtr;
    int_T currTimeIndex = run_q3_feedForward_DW.FromWorkspace1_IWORK.PrevIndex;
    real_T t = run_q3_feedForward_M->Timing.t[0];
    ...
    run_q3_feedForward_DW.FromWorkspace1_IWORK.PrevIndex = currTimeIndex;
    ...
    /* Post output */
    {
      ...
      if (t1 == t2) {
        if (t < t1) {
          run_q3_feedForward_B.FromWorkspace1 = pDataValues[currTimeIndex];
        } else {
          run_q3_feedForward_B.FromWorkspace1 = pDataValues[currTimeIndex + 1];
        }
      } else {
        ...
        run_q3_feedForward_B.FromWorkspace1 = (real_T) rtInterpolate(d1, d2, f1,
          f2);
        pDataValues += 1701;
      }
    }
   ...
   */
  run_q3_feedForward_B.TSamp = run_q3_feedForward_B.FromWorkspace1 *
   ...
   *  UnitDelay: '<S5>/UD'
   */
  rtb_CableGain = run_q3_feedForward_B.TSamp - run_q3_feedForward_DW.UD_DSTATE;
   ...
   *  y = u * K where K = 1 / ( w * Ts )
   */
  run_q3_feedForward_B.TSamp_g = rtb_CableGain *
   ...
   *  UnitDelay: '<S2>/UD'
   */
  run_q3_feedForward_B.Sum2 = (run_q3_feedForward_B.TSamp_g -
    run_q3_feedForward_DW.UD_DSTATE_i) * run_q3_feedForward_P.k_acc +
    run_q3_feedForward_P.k_vel * rtb_CableGain;

  /* Sum: '<Root>/Sum' */
  rtb_Sum = run_q3_feedForward_B.FromWorkspace1 -
   ...
   *  y = u * K where K = 1 / ( w * Ts )
   */
  run_q3_feedForward_B.TSamp_m = run_q3_feedForward_B.Gain2 *
   ...
   *  UnitDelay: '<S1>/UD'
   */
  run_q3_feedForward_DW.DiscreteTransferFcn_tmp = ((run_q3_feedForward_B.TSamp_m
    - run_q3_feedForward_DW.UD_DSTATE_n) -
    run_q3_feedForward_P.DiscreteTransferFcn_DenCoef[1] *
    run_q3_feedForward_DW.DiscreteTransferFcn_states) /
    run_q3_feedForward_P.DiscreteTransferFcn_DenCoef[0];

  /* DiscreteTransferFcn: '<Root>/Discrete Transfer Fcn' */
  run_q3_feedForward_B.DiscreteTransferFcn =
    run_q3_feedForward_P.DiscreteTransferFcn_NumCoef[0] *
   ...
   */
  rtb_CableGain = run_q3_feedForward_B.Sum3;

  /* Saturate: '<Root>/Saturation' */
  if (rtb_CableGain > run_q3_feedForward_P.Saturation_UpperSat) {
    /* Saturate: '<Root>/Saturation' */
    run_q3_feedForward_B.Saturation = run_q3_feedForward_P.Saturation_UpperSat;
  } else if (rtb_CableGain < run_q3_feedForward_P.Saturation_LowerSat) {
    /* Saturate: '<Root>/Saturation' */
    run_q3_feedForward_B.Saturation = run_q3_feedForward_P.Saturation_LowerSat;
  } else {
    /* Saturate: '<Root>/Saturation' */
    run_q3_feedForward_B.Saturation = rtb_CableGain;
  }

  /* End of Saturate: '<Root>/Saturation' */

  /* Gain: '<S3>/Cable Gain' */
  rtb_CableGain = run_q3_feedForward_P.CableGain_Gain *
    run_q3_feedForward_B.Saturation;

  /* S-Function (hil_write_analog_block): '<S3>/HIL Write Analog' */

  /* S-Function Block: run_q3_feedForward/Plant/HIL Write Analog (hil_write_analog_block) */
  {
    t_error result;
    result = hil_write_analog(run_q3_feedForward_DW.HILInitialize_Card,
      &run_q3_feedForward_P.HILWriteAnalog_channels, 1, &rtb_CableGain);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(run_q3_feedForward_M, _rt_error_message);
...
void run_q3_feedForward_update(void)
{
  /* Update for UnitDelay: '<S5>/UD' */
  run_q3_feedForward_DW.UD_DSTATE = run_q3_feedForward_B.TSamp;

  /* Update for UnitDelay: '<S2>/UD' */
  run_q3_feedForward_DW.UD_DSTATE_i = run_q3_feedForward_B.TSamp_g;
  ...
  run_q3_feedForward_DW.UD_DSTATE_n = run_q3_feedForward_B.TSamp_m;
   ...
   */
  if (!(++run_q3_feedForward_M->Timing.clockTick0)) {
    ++run_q3_feedForward_M->Timing.clockTickH0;
  }

  run_q3_feedForward_M->Timing.t[0] = run_q3_feedForward_M->Timing.clockTick0 *
    run_q3_feedForward_M->Timing.stepSize0 +
    run_q3_feedForward_M->Timing.clockTickH0 *
    run_q3_feedForward_M->Timing.stepSize0 * 4294967296.0;

  {
     ...
     */
    if (!(++run_q3_feedForward_M->Timing.clockTick1)) {
      ++run_q3_feedForward_M->Timing.clockTickH1;
    }

    run_q3_feedForward_M->Timing.t[1] = run_q3_feedForward_M->Timing.clockTick1 *
      run_q3_feedForward_M->Timing.stepSize1 +
      run_q3_feedForward_M->Timing.clockTickH1 *
      run_q3_feedForward_M->Timing.stepSize1 * 4294967296.0;
  }
}

/* Model initialize function */
void run_q3_feedForward_initialize(void)
{
  /* Start for S-Function (hil_initialize_block): '<S3>/HIL Initialize' */

  /* S-Function Block: run_q3_feedForward/Plant/HIL Initialize (hil_initialize_block) */
  {
    t_int result;
    t_boolean is_switching;
    result = hil_open("q2_usb", "0", &run_q3_feedForward_DW.HILInitialize_Card);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(run_q3_feedForward_M, _rt_error_message);
    ...
    result = hil_watchdog_clear(run_q3_feedForward_DW.HILInitialize_Card);
    ...
    if ((run_q3_feedForward_P.HILInitialize_AIPStart && !is_switching) ||
        (run_q3_feedForward_P.HILInitialize_AIPEnter && is_switching)) {
      run_q3_feedForward_DW.HILInitialize_AIMinimums[0] =
        (run_q3_feedForward_P.HILInitialize_AILow);
      run_q3_feedForward_DW.HILInitialize_AIMinimums[1] =
        (run_q3_feedForward_P.HILInitialize_AILow);
      run_q3_feedForward_DW.HILInitialize_AIMaximums[0] =
        run_q3_feedForward_P.HILInitialize_AIHigh;
      run_q3_feedForward_DW.HILInitialize_AIMaximums[1] =
        run_q3_feedForward_P.HILInitialize_AIHigh;
      result = hil_set_analog_input_ranges
        (run_q3_feedForward_DW.HILInitialize_Card,
         run_q3_feedForward_P.HILInitialize_AIChannels, 2U,
         &run_q3_feedForward_DW.HILInitialize_AIMinimums[0],
         &run_q3_feedForward_DW.HILInitialize_AIMaximums[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
    ...
    if ((run_q3_feedForward_P.HILInitialize_AOPStart && !is_switching) ||
        (run_q3_feedForward_P.HILInitialize_AOPEnter && is_switching)) {
      run_q3_feedForward_DW.HILInitialize_AOMinimums[0] =
        (run_q3_feedForward_P.HILInitialize_AOLow);
      run_q3_feedForward_DW.HILInitialize_AOMinimums[1] =
        (run_q3_feedForward_P.HILInitialize_AOLow);
      run_q3_feedForward_DW.HILInitialize_AOMaximums[0] =
        run_q3_feedForward_P.HILInitialize_AOHigh;
      run_q3_feedForward_DW.HILInitialize_AOMaximums[1] =
        run_q3_feedForward_P.HILInitialize_AOHigh;
      result = hil_set_analog_output_ranges
        (run_q3_feedForward_DW.HILInitialize_Card,
         run_q3_feedForward_P.HILInitialize_AOChannels, 2U,
         &run_q3_feedForward_DW.HILInitialize_AOMinimums[0],
         &run_q3_feedForward_DW.HILInitialize_AOMaximums[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
    ...
    if ((run_q3_feedForward_P.HILInitialize_AOStart && !is_switching) ||
        (run_q3_feedForward_P.HILInitialize_AOEnter && is_switching)) {
      run_q3_feedForward_DW.HILInitialize_AOVoltages[0] =
        run_q3_feedForward_P.HILInitialize_AOInitial;
      run_q3_feedForward_DW.HILInitialize_AOVoltages[1] =
        run_q3_feedForward_P.HILInitialize_AOInitial;
      result = hil_write_analog(run_q3_feedForward_DW.HILInitialize_Card,
        run_q3_feedForward_P.HILInitialize_AOChannels, 2U,
        &run_q3_feedForward_DW.HILInitialize_AOVoltages[0]);
    ...
    if (run_q3_feedForward_P.HILInitialize_AOReset) {
      run_q3_feedForward_DW.HILInitialize_AOVoltages[0] =
    ...
    if ((run_q3_feedForward_P.HILInitialize_EIPStart && !is_switching) ||
        (run_q3_feedForward_P.HILInitialize_EIPEnter && is_switching)) {
      run_q3_feedForward_DW.HILInitialize_QuadratureModes[0] =
        run_q3_feedForward_P.HILInitialize_EIQuadrature;
      run_q3_feedForward_DW.HILInitialize_QuadratureModes[1] =
        run_q3_feedForward_P.HILInitialize_EIQuadrature;
      result = hil_set_encoder_quadrature_mode
        (run_q3_feedForward_DW.HILInitialize_Card,
         run_q3_feedForward_P.HILInitialize_EIChannels, 2U,
    ...
    if ((run_q3_feedForward_P.HILInitialize_EIStart && !is_switching) ||
        (run_q3_feedForward_P.HILInitialize_EIEnter && is_switching)) {
      run_q3_feedForward_DW.HILInitialize_InitialEICounts[0] =
        run_q3_feedForward_P.HILInitialize_EIInitial;
      run_q3_feedForward_DW.HILInitialize_InitialEICounts[1] =
        run_q3_feedForward_P.HILInitialize_EIInitial;
      result = hil_set_encoder_counts(run_q3_feedForward_DW.HILInitialize_Card,
        run_q3_feedForward_P.HILInitialize_EIChannels, 2U,
        &run_q3_feedForward_DW.HILInitialize_InitialEICounts[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
  ...
  /* S-Function Block: run_q3_feedForward/Plant/Inverse Modulus (inverse_modulus_block) */
  {
    run_q3_feedForward_DW.InverseModulus_FirstSample = true;
    run_q3_feedForward_DW.InverseModulus_Revolutions = 0;
  }
  ...
  /* S-Function Block: run_q3_feedForward/Plant/Inverse Modulus1 (inverse_modulus_block) */
  {
    run_q3_feedForward_DW.InverseModulus1_FirstSample = true;
    run_q3_feedForward_DW.InverseModulus1_Revolutions = 0;
  }
  ...
  /* Start for FromWorkspace: '<Root>/From Workspace1' */
  {
    ...
    run_q3_feedForward_DW.FromWorkspace1_PWORK.TimePtr = (void *) pTimeValues0;
    run_q3_feedForward_DW.FromWorkspace1_PWORK.DataPtr = (void *) pDataValues0;
    run_q3_feedForward_DW.FromWorkspace1_IWORK.PrevIndex = 0;
  }
...
void run_q3_feedForward_terminate(void)
{
  ...
  /* S-Function Block: run_q3_feedForward/Plant/HIL Initialize (hil_initialize_block) */
  {
    ...
    hil_task_stop_all(run_q3_feedForward_DW.HILInitialize_Card);
    hil_monitor_stop_all(run_q3_feedForward_DW.HILInitialize_Card);
    is_switching = false;
    if ((run_q3_feedForward_P.HILInitialize_AOTerminate && !is_switching) ||
        (run_q3_feedForward_P.HILInitialize_AOExit && is_switching)) {
      run_q3_feedForward_DW.HILInitialize_AOVoltages[0] =
    ...
    if (num_final_analog_outputs > 0) {
      result = hil_write_analog(run_q3_feedForward_DW.HILInitialize_Card,
        run_q3_feedForward_P.HILInitialize_AOChannels, num_final_analog_outputs,
        &run_q3_feedForward_DW.HILInitialize_AOVoltages[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
    ...
    hil_task_delete_all(run_q3_feedForward_DW.HILInitialize_Card);
    hil_monitor_delete_all(run_q3_feedForward_DW.HILInitialize_Card);
    hil_close(run_q3_feedForward_DW.HILInitialize_Card);
    run_q3_feedForward_DW.HILInitialize_Card = NULL;
  }
}
...
{
  run_q3_feedForward_output();
  UNUSED_PARAMETER(tid);
}

void MdlUpdate(int_T tid)
{
  run_q3_feedForward_update();
  UNUSED_PARAMETER(tid);
}
...
void MdlStart(void)
{
  run_q3_feedForward_initialize();
}

void MdlTerminate(void)
{
  run_q3_feedForward_terminate();
}

/* Registration function */
RT_MODEL_run_q3_feedForward_T *run_q3_feedForward(void)
{
  /* Registration code */
  ...
  (void) memset((void *)run_q3_feedForward_M, 0,
                sizeof(RT_MODEL_run_q3_feedForward_T));

  {
    /* Setup solver object */
    rtsiSetSimTimeStepPtr(&run_q3_feedForward_M->solverInfo,
                          &run_q3_feedForward_M->Timing.simTimeStep);
    rtsiSetTPtr(&run_q3_feedForward_M->solverInfo, &rtmGetTPtr
                (run_q3_feedForward_M));
    rtsiSetStepSizePtr(&run_q3_feedForward_M->solverInfo,
                       &run_q3_feedForward_M->Timing.stepSize0);
    rtsiSetErrorStatusPtr(&run_q3_feedForward_M->solverInfo, (&rtmGetErrorStatus
      (run_q3_feedForward_M)));
    rtsiSetRTModelPtr(&run_q3_feedForward_M->solverInfo, run_q3_feedForward_M);
  }

  rtsiSetSimTimeStep(&run_q3_feedForward_M->solverInfo, MAJOR_TIME_STEP);
  rtsiSetSolverName(&run_q3_feedForward_M->solverInfo,"FixedStepDiscrete");

  /* Initialize timing info */
  {
    int_T *mdlTsMap = run_q3_feedForward_M->Timing.sampleTimeTaskIDArray;
    mdlTsMap[0] = 0;
    mdlTsMap[1] = 1;

    /* polyspace +2 MISRA2012:D4.1 [Justified:Low] "run_q3_feedForward_M points to
       static memory which is guaranteed to be non-NULL" */
    run_q3_feedForward_M->Timing.sampleTimeTaskIDPtr = (&mdlTsMap[0]);
    run_q3_feedForward_M->Timing.sampleTimes =
      (&run_q3_feedForward_M->Timing.sampleTimesArray[0]);
    run_q3_feedForward_M->Timing.offsetTimes =
      (&run_q3_feedForward_M->Timing.offsetTimesArray[0]);

    /* task periods */
    run_q3_feedForward_M->Timing.sampleTimes[0] = (0.0);
    run_q3_feedForward_M->Timing.sampleTimes[1] = (0.001);

    /* task offsets */
    run_q3_feedForward_M->Timing.offsetTimes[0] = (0.0);
    run_q3_feedForward_M->Timing.offsetTimes[1] = (0.0);
  }

  rtmSetTPtr(run_q3_feedForward_M, &run_q3_feedForward_M->Timing.tArray[0]);

  {
    int_T *mdlSampleHits = run_q3_feedForward_M->Timing.sampleHitArray;
    mdlSampleHits[0] = 1;
    mdlSampleHits[1] = 1;
    run_q3_feedForward_M->Timing.sampleHits = (&mdlSampleHits[0]);
  }

  rtmSetTFinal(run_q3_feedForward_M, 1.712);
  run_q3_feedForward_M->Timing.stepSize0 = 0.001;
...

  {
    ...
    run_q3_feedForward_M->extModeInfo = (&rt_ExtModeInfo);
    rteiSetSubSystemActiveVectorAddresses(&rt_ExtModeInfo, systemRan);
    systemRan[0] = &rtAlwaysEnabled;
    rteiSetModelMappingInfoPtr(run_q3_feedForward_M->extModeInfo,
      &run_q3_feedForward_M->SpecialInfo.mappingInfo);
    rteiSetChecksumsPtr(run_q3_feedForward_M->extModeInfo,
                        run_q3_feedForward_M->Sizes.checksums);
    rteiSetTPtr(run_q3_feedForward_M->extModeInfo, rtmGetTPtr
                (run_q3_feedForward_M));
  }

  run_q3_feedForward_M->solverInfoPtr = (&run_q3_feedForward_M->solverInfo);
  run_q3_feedForward_M->Timing.stepSize = (0.001);
  rtsiSetFixedStepSize(&run_q3_feedForward_M->solverInfo, 0.001);
  rtsiSetSolverMode(&run_q3_feedForward_M->solverInfo, SOLVER_MODE_SINGLETASKING);

  /* block I/O */
  run_q3_feedForward_M->blockIO = ((void *) &run_q3_feedForward_B);
  (void) memset(((void *) &run_q3_feedForward_B), 0,
                sizeof(B_run_q3_feedForward_T));

  /* parameters */
  run_q3_feedForward_M->defaultParam = ((real_T *)&run_q3_feedForward_P);

  /* states (dwork) */
  run_q3_feedForward_M->dwork = ((void *) &run_q3_feedForward_DW);
  (void) memset((void *)&run_q3_feedForward_DW, 0,
                sizeof(DW_run_q3_feedForward_T));
  ...
  /* Initialize Sizes */
  run_q3_feedForward_M->Sizes.numContStates = (0);/* Number of continuous states */
  run_q3_feedForward_M->Sizes.numY = (0);/* Number of model outputs */
