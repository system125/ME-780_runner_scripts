...
typedef RT_MODEL_run_q3_feedForward_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * run_q3_feedForward(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(run_q3_feedForward_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: run_q3_feedForward -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
