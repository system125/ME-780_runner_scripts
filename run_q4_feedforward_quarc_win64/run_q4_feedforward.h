...
#ifndef RTW_HEADER_run_q4_feedforward_h_
#define RTW_HEADER_run_q4_feedforward_h_
#include <math.h>
#include <string.h>
#ifndef run_q4_feedforward_COMMON_INCLUDES_
#define run_q4_feedforward_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* run_q4_feedforward_COMMON_INCLUDES_ */

#include "run_q4_feedforward_types.h"
...
#define run_q4_feedforward_rtModel     RT_MODEL_run_q4_feedforward_T

/* Block signals (default storage) */
typedef struct {
  real_T mmcn;                         /* '<S3>/mm//cn' */
  real_T InverseModulus;               /* '<S3>/Inverse Modulus' */
...
} B_run_q4_feedforward_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T UD_DSTATE;                    /* '<S5>/UD' */
  real_T UD_DSTATE_i;                  /* '<S2>/UD' */
  real_T DiscreteTimeIntegrator_DSTATE;/* '<Root>/Discrete-Time Integrator' */
  real_T UD_DSTATE_n;                  /* '<S1>/UD' */
  ...
  void *HILReadEncoder2_PWORK;         /* '<S3>/HIL Read Encoder 2' */
  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  ...
  int32_T HILReadEncoder2_Buffer;      /* '<S3>/HIL Read Encoder 2' */
  struct {
    int_T PrevIndex;
...
} DW_run_q4_feedforward_T;

/* Backward compatible GRT Identifiers */
#define rtB                            run_q4_feedforward_B
#define BlockIO                        B_run_q4_feedforward_T
#define rtP                            run_q4_feedforward_P
#define Parameters                     P_run_q4_feedforward_T
#define rtDWork                        run_q4_feedforward_DW
#define D_Work                         DW_run_q4_feedforward_T

/* Parameters (default storage) */
struct P_run_q4_feedforward_T_ {
  ...
  real_T TSamp_WtEt_c;                 /* Computed Parameter: TSamp_WtEt_c
                                        ...
                                        */
  real_T DiscreteTransferFcn_NumCoef[2];/* Expression: [(1-ad) 0]
                                         * Referenced by: '<Root>/Discrete Transfer Fcn'
                                         */
  real_T DiscreteTransferFcn_DenCoef[2];/* Expression: [1 -ad]
                                         * Referenced by: '<Root>/Discrete Transfer Fcn'
                                         */
...
struct tag_RTM_run_q4_feedforward_T {
  const char_T *path;
...
extern P_run_q4_feedforward_T run_q4_feedforward_P;

/* Block signals (default storage) */
extern B_run_q4_feedforward_T run_q4_feedforward_B;

/* Block states (default storage) */
extern DW_run_q4_feedforward_T run_q4_feedforward_DW;

/* Model entry point functions */
extern void run_q4_feedforward_initialize(void);
extern void run_q4_feedforward_output(void);
extern void run_q4_feedforward_update(void);
extern void run_q4_feedforward_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern run_q4_feedforward_rtModel *run_q4_feedforward(void);
...
extern RT_MODEL_run_q4_feedforward_T *const run_q4_feedforward_M;
 ...
 *
 * '<Root>' : 'run_q4_feedforward'
 * '<S1>'   : 'run_q4_feedforward/Discrete Derivative'
 * '<S2>'   : 'run_q4_feedforward/Discrete Derivative1'
 * '<S3>'   : 'run_q4_feedforward/Plant'
 * '<S4>'   : 'run_q4_feedforward/Subsystem'
 * '<S5>'   : 'run_q4_feedforward/Subsystem/Discrete Derivative'
 */
#endif                                 /* RTW_HEADER_run_q4_feedforward_h_ */
