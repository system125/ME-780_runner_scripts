###########################################################################
## Makefile generated for component 'run_q4_feedforward'. 
## 
## Makefile     : run_q4_feedforward.mk
## Generated on : Sat Dec 09 06:46:44 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\run_q4_feedforward.rt-win64
...
PRODUCT_NAME              = run_q4_feedforward
MAKEFILE                  = run_q4_feedforward.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2021b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2021b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\ssapkota\Downloads\Project_2_PrecisionControls\Project3_PrecisionControls\Q1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = run_q4_feedforward_comp.rsp
CMD_FILE                  = run_q4_feedforward.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\run_q4_feedforward.rt-win64
...
DEFINES_STANDARD = -DMODEL=run_q4_feedforward -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\run_q4_feedforward_quarc_win64\rtGetInf.c $(START_DIR)\run_q4_feedforward_quarc_win64\rtGetNaN.c $(START_DIR)\run_q4_feedforward_quarc_win64\rt_nonfinite.c $(START_DIR)\run_q4_feedforward_quarc_win64\run_q4_feedforward.c $(START_DIR)\run_q4_feedforward_quarc_win64\run_q4_feedforward_data.c $(START_DIR)\run_q4_feedforward_quarc_win64\run_q4_feedforward_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj run_q4_feedforward.obj run_q4_feedforward_data.obj run_q4_feedforward_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\run_q4_feedforward_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\run_q4_feedforward_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : $(START_DIR)\run_q4_feedforward_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q4_feedforward_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\run_q4_feedforward_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q4_feedforward_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\run_q4_feedforward_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q4_feedforward_quarc_win64\rt_nonfinite.c


run_q4_feedforward.obj : $(START_DIR)\run_q4_feedforward_quarc_win64\run_q4_feedforward.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q4_feedforward_quarc_win64\run_q4_feedforward.c


run_q4_feedforward_data.obj : $(START_DIR)\run_q4_feedforward_quarc_win64\run_q4_feedforward_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q4_feedforward_quarc_win64\run_q4_feedforward_data.c


run_q4_feedforward_main.obj : $(START_DIR)\run_q4_feedforward_quarc_win64\run_q4_feedforward_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\run_q4_feedforward_quarc_win64\run_q4_feedforward_main.c
