...
#ifndef RTW_HEADER_bodeTestRunner_h_
#define RTW_HEADER_bodeTestRunner_h_
#include <math.h>
#include <string.h>
#ifndef bodeTestRunner_COMMON_INCLUDES_
#define bodeTestRunner_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* bodeTestRunner_COMMON_INCLUDES_ */

#include "bodeTestRunner_types.h"
...
#define bodeTestRunner_rtModel         RT_MODEL_bodeTestRunner_T
...
typedef struct {
  ...
  real_T InverseModulus_PreviousInput; /* '<S2>/Inverse Modulus' */
  real_T InverseModulus_Revolutions;   /* '<S2>/Inverse Modulus' */
...
#define rtB                            bodeTestRunner_B
#define BlockIO                        B_bodeTestRunner_T
#define rtP                            bodeTestRunner_P
#define Parameters                     P_bodeTestRunner_T
#define rtDWork                        bodeTestRunner_DW
#define D_Work                         DW_bodeTestRunner_T
...
struct tag_RTM_bodeTestRunner_T {
  const char_T *path;
...
extern P_bodeTestRunner_T bodeTestRunner_P;

/* Block signals (default storage) */
extern B_bodeTestRunner_T bodeTestRunner_B;

/* Block states (default storage) */
extern DW_bodeTestRunner_T bodeTestRunner_DW;

/* Model entry point functions */
extern void bodeTestRunner_initialize(void);
extern void bodeTestRunner_output(void);
extern void bodeTestRunner_update(void);
extern void bodeTestRunner_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern bodeTestRunner_rtModel *bodeTestRunner(void);
...
extern RT_MODEL_bodeTestRunner_T *const bodeTestRunner_M;
 ...
 *
 * '<Root>' : 'bodeTestRunner'
 * '<S1>'   : 'bodeTestRunner/Discrete Derivative'
 * '<S2>'   : 'bodeTestRunner/Plant'
 */
#endif                                 /* RTW_HEADER_bodeTestRunner_h_ */
