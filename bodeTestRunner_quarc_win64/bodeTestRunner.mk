...
COMPILER_COMMAND_FILE     = bodeTestRunner_comp.rsp
CMD_FILE                  = bodeTestRunner.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\bodeTestRunner.rt-win64
...
DEFINES_STANDARD = -DMODEL=bodeTestRunner -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\bodeTestRunner_quarc_win64\bodeTestRunner.c $(START_DIR)\bodeTestRunner_quarc_win64\bodeTestRunner_data.c $(START_DIR)\bodeTestRunner_quarc_win64\bodeTestRunner_main.c $(START_DIR)\bodeTestRunner_quarc_win64\rtGetInf.c $(START_DIR)\bodeTestRunner_quarc_win64\rtGetNaN.c $(START_DIR)\bodeTestRunner_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = bodeTestRunner.obj bodeTestRunner_data.obj bodeTestRunner_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\bodeTestRunner_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\bodeTestRunner_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
bodeTestRunner.obj : $(START_DIR)\bodeTestRunner_quarc_win64\bodeTestRunner.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\bodeTestRunner_quarc_win64\bodeTestRunner.c


bodeTestRunner_data.obj : $(START_DIR)\bodeTestRunner_quarc_win64\bodeTestRunner_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\bodeTestRunner_quarc_win64\bodeTestRunner_data.c


bodeTestRunner_main.obj : $(START_DIR)\bodeTestRunner_quarc_win64\bodeTestRunner_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\bodeTestRunner_quarc_win64\bodeTestRunner_main.c


rtGetInf.obj : $(START_DIR)\bodeTestRunner_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\bodeTestRunner_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\bodeTestRunner_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\bodeTestRunner_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\bodeTestRunner_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\bodeTestRunner_quarc_win64\rt_nonfinite.c
