    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(26)  = dumData; %prealloc
                    ...
                    ;% bodeTestRunner_P.SineWave_Amp
                    section.data(20).logicalSrcIdx = 22;
                    section.data(20).dtTransOffset = 19;

                    ;% bodeTestRunner_P.SineWave_Bias
                    section.data(21).logicalSrcIdx = 23;
                    section.data(21).dtTransOffset = 20;

                    ;% bodeTestRunner_P.SineWave_Freq
                    section.data(22).logicalSrcIdx = 24;
                    section.data(22).dtTransOffset = 21;

                    ;% bodeTestRunner_P.SineWave_Phase
    ...
    targMap.checksum0 = 178411266;
    targMap.checksum1 = 2145821607;
    targMap.checksum2 = 67147437;
    targMap.checksum3 = 3059341886;
