    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(17)  = dumData; %prealloc
                    ...
                    ;% bodeTestRunner_DW.TimeStampA
                    section.data(14).logicalSrcIdx = 13;
                    section.data(14).dtTransOffset = 19;

                    ;% bodeTestRunner_DW.LastUAtTimeA
                    section.data(15).logicalSrcIdx = 14;
                    section.data(15).dtTransOffset = 20;

                    ;% bodeTestRunner_DW.TimeStampB
                    section.data(16).logicalSrcIdx = 15;
                    section.data(16).dtTransOffset = 21;

                    ;% bodeTestRunner_DW.LastUAtTimeB
    ...
    targMap.checksum0 = 4261501938;
    targMap.checksum1 = 1820693036;
    targMap.checksum2 = 143904725;
    targMap.checksum3 = 3005936738;
